...
public class GravarMedicoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        NovoMedicoFormBean nmfb = (NovoMedicoFormBean) request.getSession().getAttribute("novoMedico");
        ...
        try {
            Medico m = new Medico();
            m.setCrm(nmfb.getCrm());
            m.setNome(nmfb.getNome());
            m.setSenha(nmfb.getSenha());
            m.setEspecialidade(nmfb.getEspecialidade());
